...
log "            sudo -n -u ${DEPLOY_USER} ${G2}/run-recovery.sh lightrag-reprocess"
log "            (NFM-4816: re-enqueue lightrag FAILED/PENDING docs now; the"
log "             NFM-4804 watchdog also runs this after every wedge restart)"
