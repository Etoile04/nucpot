...
#
# The AC-1 v2 catalog_gap tests below this block were added on this branch
# by NFM-4013 Path (a); both test groups coexist because they assert
# orthogonal contracts on ``_aggregate`` / ``_write_tsv``.
# ---------------------------------------------------------------------------
