...
def get_storage() -> StorageBackend:
    ...
    if backend == "s3":
        # S3Storage.__init__ raises NotImplementedError; cast the class so mypy
        # accepts the return type satisfies StorageBackend's structural Protocol
        # (calls will fail at runtime, which is the intended seam behavior).
