"""ADR-009 §4.3-c feature flag (NFM-3601).
...
Environment variable: ``NFM_ADR_009_RECONCILE_ROUTINE_ENABLED``. The flag is
...
_FLAG_ENV: str = "NFM_ADR_009_RECONCILE_ROUTINE_ENABLED"
_FLAG_NAME: str = "ADR_009_RECONCILE_ROUTINE_ENABLED"
