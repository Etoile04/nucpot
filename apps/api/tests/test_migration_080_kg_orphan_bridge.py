...
class TestMigration080Chain:
    ...
    def test_080_is_single_head(self, script_directory: ScriptDirectory) -> None:
        ...
        reconciliation) extended it again; the NFM-4550 G1-D migration
        ...
        chained after 088.  NFM-4744 then chained
        090_add_rag_index_audit_failure_kind after 089 — 090 is the
        current head.  This keeps
        asserting "exactly one
        head" so a future bad down_revision still fails loudly here.
        """
        heads = script_directory.get_heads()
        current_head = "090_add_rag_index_audit_failure_kind"
