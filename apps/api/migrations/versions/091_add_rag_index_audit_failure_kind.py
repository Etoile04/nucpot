"""091 — rag_index_audit_log.failure_kind (NFM-4742-B / NFM-4744)
...
(NFM-4742-INTEG) reconciles them at merge time — this migration is
renumbered from 090 → 091 during integration so it chains after
NFM-4743's ``090_add_lightrag_doc_failure`` instead of forking from
``089_add_ix_verification_tasks_status``.
...
Revision ID: 091_add_rag_index_audit_failure_kind
Revises: 090_add_lightrag_doc_failure
"""
...
revision: str = "091_add_rag_index_audit_failure_kind"
down_revision: str | Sequence[str] | None = "090_add_lightrag_doc_failure"
