...
const NFMD_SPEC_PATTERN =
  /(?:review-queue-auth|review-conflicts|rag-chat|md-verification(?:-workflow|-hpc)?|ontology-record-ref|ontology|verification-linkage|review-api-smoke|nfm625-v4-visual-qa|design-workspace|design-responsive)\.spec\.ts$/
