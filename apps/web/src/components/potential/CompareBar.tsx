...
export function CompareBar({ selectedIds, potentials, onRemove, onClear }: CompareBarProps) {
  ...
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 bg-gray-800/90 border-t border-gray-700 backdrop-blur-lg">
