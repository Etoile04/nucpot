      ...
      <main className="max-w-4xl mx-auto px-6 py-12 space-y-12">
        ...
        <section>
          ...
          <ul className="space-y-2 text-gray-400">
            <li className="flex items-start gap-2">
              ...
              <span className="font-mono text-gray-300">444469cda</span>）
              执行时把同一文献的重复占位{" "}
            ...
            <li className="flex items-start gap-2">
              ...
              <span className="font-mono text-gray-300"> Unknown Source </span>
              与
              <span className="font-mono text-gray-300">
                {" "}
        ...
        <section>
          ...
          <ul className="space-y-2 text-gray-400">
            <li className="flex items-start gap-2">
              <span className="text-blue-400 mt-1">•</span>
              <span className="font-mono text-gray-300">NFM-4130</span>（提交
              <span className="font-mono text-gray-300"> 570a2e2f</span>，PR
              #1107）——将迁移 070 的“坏数据源”判定范围收窄至 UUID
              标题行，移除占位标题类，防止占位合并再次触发。
            </li>
            <li className="flex items-start gap-2">
              <span className="text-blue-400 mt-1">•</span>
              迁移 <span className="font-mono text-gray-300">075</span>
              （NFM-4139）——从
              <span className="font-mono text-gray-300">
                {" "}
              ...
              <span className="font-mono text-gray-300">data_sources</span>与 10
              条 <span className="font-mono text-gray-300">datasets</span>{" "}
              记录。
            </li>
            <li className="flex items-start gap-2">
              <span className="text-blue-400 mt-1">•</span>
              迁移 <span className="font-mono text-gray-300">079</span>
              （NFM-4191）——从
              <span className="font-mono text-gray-300">
                {" "}
            ...
            <li className="flex items-start gap-2">
              <span className="text-blue-400 mt-1">•</span>
              迁移 <span className="font-mono text-gray-300">077</span>
              （NFM-4159 §5.1）——将
              <span className="font-mono text-gray-300">
                {" "}
                datasets.source_id{" "}
