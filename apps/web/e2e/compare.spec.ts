...
/**
 * E2E tests for the Compare page (/potentials/compare, moved from /compare
 * by NFM-4987 — legacy /compare 308s here, see legacy-route-redirects.spec.ts).
 *
 * Covers:
...
test.describe("Compare Page", { tag: "@smoke" }, () => {
  test("loads the compare page and shows empty state guidance", async ({
    ...
    await page.goto("/potentials/compare", { waitUntil: "domcontentloaded" })
